package com.suntek.algorithm.dtw
...
class DtwTest {
  @Test
  def dtwFunction(): Unit = {
    val s = Array[Long](1604544221,1604544285,1604544295,1604544379)
    val q = Array[Long](1604544212, 1604544285,1604544293,1604544328)
    val ret = SparseDTW.spDTW_v2(s, q, 600)
    println(ret)
  }
  ...
  : Unit = {
    ...
    val saveParamBean = new SaveParamBean("test_zhy", Constant.OVERRIDE, database.getDataBaseBean)
