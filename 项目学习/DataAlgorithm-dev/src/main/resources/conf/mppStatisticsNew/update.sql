...
select
 ...
 case when s.first_time is null and t.first_time is not null  then  t.first_device_id
  ...
  (case when t.all_cnt is null then s.cnt
	...
	@BATCH_TIME@ as pt
from
  (select  id,first_time,first_device_id,first_device_type,last_time,last_device_id,last_device_type,all_cnt,cnt,data_type,pt from tb_track_statistics where pt=@BATCH_TIME@ )t
  full outer  join
 (
select  id,first_time,first_device_id,first_device_type,last_time,last_device_id,last_device_type, sum(cnt) as cnt, data_type ,  @BATCH_TIME@ as pt  from(
...
,data_type,cnt
 ...
 ) t group by id,data_type,first_time,first_device_id,first_device_type,last_time,last_device_id,last_device_type
...
insert into tb_track_statistics(id,first_time,first_device_id,first_device_type,last_time,last_device_id,last_device_type,all_cnt,cnt,data_type,pt)
select id,first_time,first_device_id,first_device_type,last_time,last_device_id,last_device_type,all_cnt,cnt,data_type,pt from tb_track_statistics_tmp
